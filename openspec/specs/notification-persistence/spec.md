...
Durable, database-backed storage of notification records, shared between the API and worker processes, so status is available independent of channel-provider and queue availability.
