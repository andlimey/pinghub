...
Per-channel send integrations invoked by the delivery pipeline: real provider integrations for email and push, and a mock sender for SMS pending Singapore Sender ID registration.
